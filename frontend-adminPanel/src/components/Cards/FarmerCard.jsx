...
export default function FarmerCard(props) {
  ...
  return (
    <div 
    className='max-h-[22vh] w-[100%] rounded-lg bg-white flex flex-col gap-2 justify-center p-2 shadow-sm hover:scale-110'
    >
        <div className='w-full flex flex-col flex-[2] bg-accent/30 rounded-lg p-3 relative'>

            <div className='w-[20%] h-5 rounded-lg
             absolute top-2 right-2 flex flex-row gap-2'>
                    <div className='bg-green-300 h-[100%] rounded-lg flex flex-[1] items-center justify-center'>
            ...
            <p className='text-sm text-foreground'>{place}, {state}</p>
        </div>
