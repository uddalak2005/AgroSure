...
import '../App.css'
import KioskCard from '../components/Cards/kioskCard';
export default function AllKiosks() {
  ...
  return (
    <div className='w-full h-[100vh] flex flex-col items-center justify-center p-2'>
        <div className='w-full bg-accent/50 flex flex-[2] justify-center items-center'>
        ...
        <div className='w-full flex flex-col flex-[9] items-center overflow-y-auto p-4 bg-background'>
        <div className='w-[80%] flex flex-col items-start mb-4'>
            <h1 className='text-2xl font-bold text-foreground mb-2'>All Kiosks</h1>
            <p className='text-sm text-muted-foreground mb-1'>Manage and view all kiosks registered in the system</p>
        </div>

            <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:grid-cols:4
             w-[100%] lg:w-[80%] overflow-y-auto max-h-[100%] bg-background
              border-t-2 bg-secondary/50 rounded-lg
              scrollbar-hide p-3'>
