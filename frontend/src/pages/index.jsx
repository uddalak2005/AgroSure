        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <button
              ...
              className="bg-agricultural-forest-green hover:bg-agricultural-crop-green
               text-white transition-all duration-300 px-4 py-2 rounded-md text-sm font-medium"
            >
              Get Started
            </button>
          </div>
